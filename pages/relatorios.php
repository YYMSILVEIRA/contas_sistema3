...
function enviarEmail($destinatario, $assunto, $mensagem, $descricao_personalizada = '', $cc_email = '') {
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'adm@ib2s.xyz'; // Seu e-mail
        $mail->Password = '!S@b&ll@2021@__@'; // Sua senha ou senha de app
        ...
        $mail->setFrom('contas_sistema@ib2s.xyz', 'Resumo Financeiro | Contas Sistema');
