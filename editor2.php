...
<body class="bg-light">
    ...
    <div class="modal fade" id="editorModal" tabindex="-1" aria-labelledby="editorModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- Campo de pesquisa no editor -->
                    <div class="mb-3">
                        <input type="text" id="pesquisaEditor" class="form-control" placeholder="Pesquisar no texto...">
                    </div>
    ...
    <script>
       ...
       // Variável para armazenar o item atualmente aberto
        ...
        // Função para destacar o texto pesquisado no editor
        document.getElementById('pesquisaEditor').addEventListener('input', function () {
            const termo = this.value.trim();
            const conteudoEditor = document.getElementById('conteudoEditor');
            const texto = conteudoEditor.value;

            if (termo === '') {
                conteudoEditor.innerHTML = texto; // Remove o destaque se o campo de pesquisa estiver vazio
                return;
            ...
            // Atualiza o conteúdo do textarea com o texto destacado
            conteudoEditor.innerHTML = textoDestacado;
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            editorModal.addEventListener('show.bs.modal', function (event) {
                ...
                // Carrega o conteúdo do arquivo via fetch
