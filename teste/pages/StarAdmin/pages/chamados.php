            ...
            <div class="col-md-11 grid-margin stretch-card">
                ...
                <div class="card-body">
                  ...
                  <p class="card-description">
                    Preecha os campos solicitados
                  </p>

                    <!-- Form de registro-->   
                <form action="../Classes/ProcessaChamado.php" method="POST">  
                        <div class="form-group">
                           ...
                           ?>
                              <label>Nome</label>
                              <input type="text" class="form-control " placeholder="Username" aria-label="Username" name="nome" required="Preecha os campos" >
                           </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-3"> 
                              <label>Qual seu setor</label>
                              <input type="text" class="form-control " placeholder="Username" aria-label="Username" name="setor" required="Preecha os campos">
                           </div>
                        </div>                  
                        ...
                        <div class="col-sm-3">
                        <div class="form-group">
                          <label for="exampleFormControlSelect1">Selecione a opção que mais se adequa a sua demanda</label>
                          <select class="form-control form-control-lg" id="exampleFormControlSelect1" name="solicitacao" >
                            <option>Problema no hardware</option>
                            <option>Resultado está incorreto</option>
                            <option>Alterar dados</option>
                            <option>Reset de Senha</option>
                          </select>
                        </div>
                        <div class="form-group">
                          <label for="exampleFormControlSelect1">Sla</label>
                          <select class="form-control form-control-lg" id="exampleFormControlSelect1" name="sla" >
                         ...
                         <input type="reset"  value="Limpar" onClick=parent.location="javascript:location.reload()" class="btn btn-primary">
                 </form> 
<br>
                       ...
                       <table class="table table-striped">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td><?php echo $var["solicitacao"]; ?></td>
                                <td><?php echo $var["sla"]; ?></td>
                                <?php } ?> 
                            </tbody>
                          </table>
                      </div>
