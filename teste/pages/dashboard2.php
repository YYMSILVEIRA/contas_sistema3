   ...
   <div class="row mt-4 chart-container">
       ...
       <div class="col-md-6">
        ...
        <div class="quick-links">
            ...
            <ul>
                <?php if ($isAdmin): ?>
                    <li><a href="gerenciar_usuarios.php"><b>Gerenciador de Usuários</b></a></li>
                    <li><a href="enviar_emails.php"><b>Disparar E-mail contas vencendo</b></a></li>
                    <li><a href="visualizar_logs.php"><b>Logs da plataforma</b></a></li>
                    <li><a href="../editor.php"><b>Editor de código integrado</b></a></li>
                <?php endif; ?>
                <li><a href="adicionar_contas_pagar.php">Adicionar Conta a Pagar</a></li>
                <li><a href="adicionar_contas_receber.php">Adicionar Conta a Receber</a></li>
                <li><a href="relatorios.php">Ver Relatórios</a></li>
                <li><a href="cadastrar_cliente_fornecedor.php">Cadastrar Cliente/Fornecedor</a></li>
                <li><a href="listar_clientes_fornecedores.php">Listar Clientes/Fornecedores</a></li>
                <li><a href="editar_registro_pagar_manual.php">Editar Conta a Pagar</a></li>
                <li><a href="editar_registro_receber_manual.php">Editar Conta a Receber</a></li>
                <!--<li><a href="cadastrar_centro_custos.php">Cadastrar Centro Custos</a></li>
                <li><a href="cadastrar_conta_contabil.php">Cadastrar Conta Contabil</a></li>
                <li><a href="listar_centros_custos.php">Listar Centros Custos</a></li>
                <li><a href="listar_contas_contabeis.php">Listar Contas Contabeis</a></li>-->
